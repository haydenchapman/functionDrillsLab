...
const exlaimThree = str => { return str.toUpperCase() + '!!!'}
...
let nameGreeting = nameCheck('Hayden')
////////////////// PROBLEM 11 ////////////////////
/*
...
*/
//CODE HERE
function isAscending(myArr){
    for (let i = 0; i < myArr.length; i++){
      if (i > 0 && myArr[i-1] > myArr[i]){
        return false;
      }
    }
    return true;
